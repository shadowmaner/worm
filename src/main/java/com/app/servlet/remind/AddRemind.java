package com.app.servlet.remind;
...
import com.app.po.Remind;
import com.app.service.CalendarService;
import com.app.service.RemindService;
...
public class AddRemind extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Integer userId = Integer.parseInt(request.getParameter("userId"));//user id
